...
namespace Monoscape.Common.Services.FileServer
{
	...
	public interface IFileTransferService
	{
        ...
        [FaultContract(typeof(MonoscapeFault))]
        UploadApplicationResponse UploadApplication(UploadApplicationRequest request);

        [OperationContract(IsOneWay = false)]
        [FaultContract(typeof(MonoscapeFault))]
        DownloadApplicationResponse DownloadApplication(DownloadApplicationRequest request);
	}
}
