...
namespace Monoscape.Common.Sockets.FileServer
{
    ...
    public abstract class AbstractFileTransferSocket
    {
        ...
        {
            Log.Debug(typeof(AbstractFileTransferSocket), "SendFile()");               
            ...
            if (fileNameInBytesLength.Length > 4)
                throw new MonoscapeException("File name length is too long. Please reduce the file name length and try again.");
            ...
            using (fileStream)
            {
                ...
                Log.Debug(typeof(AbstractFileTransferSocket), "Starting ApFileTransferServerSocket...");
                ...
                Log.Debug(typeof(AbstractFileTransferSocket), "Reading file: " + fileName);
                ...
                while (bytesToRead > 0)
                {
                    ...
                    Log.Debug(typeof(AbstractFileTransferSocket), "Total bytes sent: " + totalBytesRead + " Remaining: " + bytesToRead);
                }
                Log.Debug(typeof(AbstractFileTransferSocket), "File sent successfully"); 
            }                                  
        }
